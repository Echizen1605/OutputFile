...
parser.add_argument('--train-dir', default=os.path.expanduser('/data1/train'),
                    help='path to training data')
parser.add_argument('--val-dir', default=os.path.expanduser('/data1/valid2'),
...
if resume_from_epoch > 0 and hvd.rank() == 0:
    ...
    print("加载完毕!epoch:",resume_from_epoch)
